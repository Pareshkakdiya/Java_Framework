...
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 512, maxFileSize = 1024 * 1024 * 1024, maxRequestSize = 1024 * 1024 * 512) // 512MB
public class ProductController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	     ...
	     if (action.equalsIgnoreCase("add product")){
	    	 ...
	    	 String savePath = "C:\\Users\\LENOVO\\eclipse-workspace\\MyProject\\src\\main\\webapp\\product_images";
	    	 ...
	    	 String savePath2 ="C:\\Users\\LENOVO\\eclipse-workspace\\MyProject\\src\\main\\webapp\\product_images";
