	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if (action.equalsIgnoreCase("login"))
		{
			...
			}else
			{
			   ...
			   if (u.getPassword().equals(request.getParameter("old_password")))
			   {
				...
				else
				{
					if (u.getUsertype().equals("buyer")) {
						request.setAttribute("msg", "Password & Confirm Password Doese Not Matched");
			   ...
			   {
				   request.setAttribute("msg", "Old Password Doese Not Matched");
					request.getRequestDispatcher("change-password.jsp").forward(request, response);
			   }
			   else {
				   request.setAttribute("msg", "Old Password Doese Not Matched");
		...
		else if (action.equalsIgnoreCase("update password")) 
		{
			...
			else
			{
				...
				request.getRequestDispatcher("new-password").forward(request, response);	
			}
		}
    }
