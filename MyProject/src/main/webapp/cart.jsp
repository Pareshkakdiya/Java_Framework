								...
								<table class="table">
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="product-details.jsp?pid=<%=p.getPid()%>"><img
													src="product_images/<%=p.getProduct_img()%>" alt="img"></a></td>
		...
		<table border="1">
			<tbody>
				...
				<tr>
					...
					<td><input id="CUST_ID" tabindex="2" maxlength="30" size="12" name="CUST_ID" autocomplete="off" value="CUST_<%=randomInt %>"></td>
				</tr>
				<tr>
					<td>3</td>
