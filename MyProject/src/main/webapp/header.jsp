				...
				<div class="menu_main">
					<ul>
                     ...
                     if(session!=null)
                     {
						...
						<li><a href="wishlist.jsp">Wishlist(<%=session.getAttribute("wishlist_count") %>)
						</a></li>
						<li><a href="cart.jsp">Cart(<%=session.getAttribute("cart_count") %>)
						</a></li>
						<li><a href="logout.jsp">Logout(<%=u.getFname()%>)
						</a></li>
						<%
                    	 }
                    	 else
