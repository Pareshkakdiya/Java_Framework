                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a data-lens-image="product_images/<%=p.getProduct_img() %>"><img src="product_images/<%=p.getProduct_img() %>" class="simpleLens-big-image"></a></div>
                      </div>
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    if(session!=null)
                    {
                    	...
                    	{
                    	%>
                    	    <a class="aa-add-to-cart-btn" href="login.jsp">Login</a>
                    	<% 
                        }
                    }
                    else
